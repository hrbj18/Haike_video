...
def _load_dotenv() -> None:
    ...
    # Keep credentials in the Git-ignored secrets file.  Load it before the
    # normal local override and checked-in template; process-level variables
    # still win because this loader only sets missing keys.
    for env_path in (
