"""Bridge Haike Video playbooks → HyperFrames-friendly style artifacts.

Haike Video playbooks are YAML files describing visual_language, typography,
...
def _render_design_md(
    ...
    lines = [
        title,
        "",
        f"> Generated by Haike Video HyperFrames style bridge (source: {source_note}).",
        "",
        "## Colors",
        "",
