...
> This repository contains the Windows production-workbench fork. For the reproducible setup, private-asset migration, and acceptance boundaries, follow the [Windows deployment guide](docs/DEPLOYMENT_WINDOWS_ZH-CN.md).

### Prerequisites

- **Windows 10/11 x64** with PowerShell 5.1+
- **64-bit Python 3.12** — [python.org](https://www.python.org/downloads/)
- **Node.js 22+** with npm — [nodejs.org](https://nodejs.org/)
- **Git for Windows** — [git-scm.com](https://git-scm.com/download/win)
- **An AI coding assistant** — Claude Code, Cursor, Copilot, Windsurf, or Codex

FFmpeg/ffprobe are supplied by a pinned Python dependency for this workflow.
...
> `scripts\setup.ps1` creates the Python 3.12 environment, installs core/test/faster-whisper dependencies, runs lockfile-driven `npm ci`, and prepares the isolated OpenMontage local-TTS runtime. Put real credentials only in the generated `.env.local`; never commit them.
