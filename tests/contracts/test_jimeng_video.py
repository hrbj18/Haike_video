...
class TestToolSpecific:
    ...
    def test_safe_error_redacts_keys(self, monkeypatch):
        monkeypatch.setenv("VOLC_ACCESSKEY", "TEST_VOLC_ACCESS_KEY_NOT_REAL")
        monkeypatch.setenv("VOLC_SECRETKEY", "TEST_VOLC_SECRET_KEY_NOT_REAL")
        redacted = JimengVideo._safe_error(
            Exception("failed with ak=TEST_VOLC_ACCESS_KEY_NOT_REAL sk=TEST_VOLC_SECRET_KEY_NOT_REAL")
        )
        assert "TEST_VOLC_ACCESS_KEY_NOT_REAL" not in redacted
        assert "TEST_VOLC_SECRET_KEY_NOT_REAL" not in redacted
