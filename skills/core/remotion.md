...
**This file** teaches how Haike Video uses Remotion — which compositions map to pipeline
...
| Haike Video Artifact | Remotion Prop | Maps To |
|---------------------|---------------|---------|
...
| Haike Video Profile | Remotion Config |
|--------------------|-----------------|
